...
import top.gn.rpc.enumeration.SerializerCode;
import top.gn.rpc.exception.SerializeException;
 ...
 * 主要特点是高性能、高效和易用。最重要的两个特点，一是基于字节的序列化，对空间利用率较高，在网络传输时可以减小体积；
 * 二是序列化时记录属性对象的类型信息，这样在反序列化时就不会出现之前的问题了。
 *
 * Kryo 可能存在线程安全问题，文档上是推荐放在 ThreadLocal 里，
...
public class KryoSerializer implements CommonSerializer {
    ...
    public byte[] serialize(Object obj) {
        ...
        Output output = new Output(byteArrayOutputStream)) {
            ...
            throw new SerializeException("序列化时候有错误发生");
        }
    }
